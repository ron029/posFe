            ...
            >
                <template slot="top">
                    <v-toolbar flat>
                        ...
                        ></v-divider>
                        <v-spacer></v-spacer>
                        <v-btn @click="newCatItem()" :disabled="!isUserCanCreateCategories" color="success"><v-icon>mdi-plus</v-icon>New</v-btn>
                    </v-toolbar>
                    <v-text-field
                        style="margin: 0 17px"
                        label="Search"
                ...
                <template slot="item.actions" slot-scope="{ item }">
                    <v-icon @click="editItem(item)" :disabled="!isUserCanUpdateCategories" color="warning">mdi-pencil</v-icon>
        ...
        >
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn disabled color="success" @click="deleteCategory">proceed</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    <!-- /dialogs -->
