<template>
    <v-dialog
        ...
        width="400"
    >
        <v-card style="width: 400px" id="printableArea">
            <v-card-title style="background-color: blue; color: white">Change Info</v-card-title>
            <v-card-text class="text-center" style="padding: 30px 0; height: 100%">
                ...
                <p>Press <v-chip x-small class="chip">P</v-chip> to print <v-icon>mdi-receipt-text</v-icon> receipt</p>
            </v-card-text>
        </v-card>
    </v-dialog>
</template>
