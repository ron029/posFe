<template>
    <div>
        ...
        <div style="height: 100px; width: 100px; background-color: blue; color: white; margin-bottom: 10px">ALT + D Delete Item</div>
        <div style="height: 100px; width: 100px; background-color: blue; color: white; margin-bottom: 10px">ALT + Q Edit QTY</div>
    </div>
</template>
